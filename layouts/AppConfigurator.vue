...
const updateColors = (type: 'primary' | 'surface', color: PrimaryColorOption | SurfaceOption) => {
    if (type === 'primary') {
...
const applyTheme = (type: 'primary' | 'surface', color: PrimaryColorOption | SurfaceOption) => {
    if (type === 'primary') {
